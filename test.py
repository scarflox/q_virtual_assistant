...
from core.utils import tool_to_openai, initiate_winfetch
from temputils import tool_to_openai, initiate_winfetch, winfetch_refresher_loop
        ...
        with mic as source:
            ...
            while True:
                ...
                try:
                    ...
                    if current_time - last_winfetch_refresh >= WINFETCH_TIMEOUT:
                        winfetch_output, header_height = initiate_winfetch()
                        last_winfetch_refresh = time.time()

                        redraw_terminal(winfetch_output, header_height, last_3_lines)
